package com.example.java_adv2.charset;
...
public class EncodingMain2 {
  ...
  public static void main(String[] args) {
    ...
    test("가", EUC_KR, UTF_8); // 인코딩 가능, 디코딩 X
    test("가", MS_949, UTF_8); // 인코딩 가능, 디코딩 X
    test("가", UTF_8, MS_949); // 인코딩 가능, 디코딩 X
    test("가", UTF_8, UTF_16BE); // 인코딩 가능, 디코딩 X
    test("가", UTF_16BE, UTF_8); // 인코딩 가능, 디코딩 X

    System.out.println("== 영문 인코딩 - 디코딩이 다른 경우 ==");
    test("A", EUC_KR, UTF_8);
    test("A", MS_949, UTF_8);
    test("A", UTF_8, MS_949);
    test("A", UTF_8, UTF_16BE); // 인코딩 가능, 디코딩 X
