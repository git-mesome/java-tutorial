...
public class OptionalProcessingMain {
  ...
  public static void main(String[] args) {
    ...
    optEmpty.ifPresent(v -> System.out.println("optEmpty 값: " + v)); // 아무 일도 안 함
    ...
    optValue.ifPresentOrElse(
        ...
        () -> System.out.println("optValue는 비어 있습니다.")
    );
    optEmpty.ifPresentOrElse(
        v -> System.out.println("optEmpty 값: " + v),
        () -> System.out.println("optEmpty는 비어 있습니다.")
    );
    ...
    optEmpty.stream()
        .forEach(s -> System.out.println("optEmpty.stream() = " + s)); // 아무 일도 안 함
